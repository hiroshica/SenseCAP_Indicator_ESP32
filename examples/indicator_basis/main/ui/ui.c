...
void ui_screen_time_screen_init(void)
{
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ui_ipaddr = lv_label_create(ui_background);
      lv_obj_set_width(ui_ipaddr, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_ipaddr, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_ipaddr, 130);
      lv_obj_set_y(ui_ipaddr, 20);
...
void ui_screen_sensor_screen_init(void)
{
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ui_ipaddr2 = lv_label_create(ui_screen_sensor);
      lv_obj_set_width(ui_ipaddr2, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_ipaddr2, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_ipaddr2, 130);
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ui_pa = lv_btn_create(ui_screen_sensor);
      lv_obj_set_width(ui_pa, 140); /// 436
      lv_obj_set_height(ui_pa, 140);
      lv_obj_set_x(ui_pa, 0); /// 0
      lv_obj_set_y(ui_pa, -100);
      lv_obj_set_align(ui_pa, LV_ALIGN_CENTER);
      lv_obj_add_flag(ui_pa, LV_OBJ_FLAG_SCROLL_ON_FOCUS); /// Flags
      lv_obj_clear_flag(ui_pa, LV_OBJ_FLAG_SCROLLABLE);    /// Flags
      lv_obj_set_style_bg_color(ui_pa, lv_color_hex(0x4169e1), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_pa, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      ...
      ui_pa_data = lv_label_create(ui_pa);
      lv_obj_set_width(ui_pa_data, 100);
      lv_obj_set_height(ui_pa_data, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_pa_data, -35);                  //-90
      lv_obj_set_y(ui_pa_data, 0);
      lv_obj_set_align(ui_pa_data, LV_ALIGN_CENTER);
      lv_label_set_text(ui_pa_data, "0000"); //"N/A ");
      lv_obj_set_style_text_align(ui_pa_data, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_font(ui_pa_data, &ui_font_font2, LV_PART_MAIN | LV_STATE_DEFAULT);
      ...
      lv_obj_set_height(ui_tvoc_2, 140);
      lv_obj_set_x(ui_tvoc_2, -148);
      lv_obj_set_y(ui_tvoc_2, 45);
      ...
      lv_obj_set_y(ui_tvoc_icon_2, -35);
      ...
      lv_obj_set_y(ui_tvoc_title_2, -35);
      ...
      lv_obj_set_height(ui_temp2, 140);
      lv_obj_set_x(ui_temp2, 0);
      lv_obj_set_y(ui_temp2, 45);
      ...
      lv_obj_set_y(ui_temp_icon_2, -35);
      ...
      lv_obj_set_y(ui_temp_title_2, -35);
      ...
      lv_obj_set_height(ui_humidity2, 140);
      lv_obj_set_x(ui_humidity2, 148);
      lv_obj_set_y(ui_humidity2, 45);
      ...
      lv_obj_set_y(ui_humidity_icon_2, -35);
      ...
      lv_obj_set_y(ui_humidity_title_2, -35);
...
void ui_screen_setting_screen_init(void)
{
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ui_ipaddr3 = lv_label_create(ui_screen_setting);
      lv_obj_set_width(ui_ipaddr3, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_ipaddr3, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_ipaddr3, 130);
